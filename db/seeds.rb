...
# Item.create(name:"Red Shirt", price:"$29.99", sizes:"S,M,L,XL", subcategory_id:1, retailer_id:1, image:'.../assets/test_data_images/Red_Shirt.JPG')
# Item.create(name:"Yellow Shirt", price:"$34.99", sizes:"S,M,L,XL", subcategory_id:4, retailer_id:3, image:'.../assets/test_data_images/Yellow_Shirt.JPG')
# Item.create(name:"Black Shoes", price:"$79.99", sizes:"8,9,10,11,12", subcategory_id:10, retailer_id:1, image:'.../assets/test_data_images/Black_Shoes.JPG')
# Item.create(name:"Blue Shoes", price:"$75.99", sizes:"8,9,10,11,12", subcategory_id:10, retailer_id:3, image:'.../assets/test_data_images/Blue_Shoes.JPG')
# Item.create(name:"Green Shoes", price:"$65.99", sizes:"8,9,10,11", subcategory_id:10, retailer_id:2, image:'.../assets/test_data_images/Green_Shoes.JPG')
# Item.create(name:"Red Shoes", price:"$69.99", sizes:"7,8,9,10", subcategory_id:10, retailer_id:3, image:'.../assets/test_data_images/Red_Shoes.JPG')
# Item.create(name:"Black Skirt", price:"$40.99", sizes:"S,M,L,XL", subcategory_id:5, retailer_id:2, image:'.../assets/test_data_images/Black_Skirt.JPG')
# Item.create(name:"Blue Skirt", price:"$39.99", sizes:"S,M,L", subcategory_id:5, retailer_id:1, image:'.../assets/test_data_images/Blue_Skirt.JPG')
# Item.create(name:"Purple Skirt", price:"$35.99", sizes:"S,M,L,XL", subcategory_id:5, retailer_id:3, image:'.../assets/test_data_images/Purple_Skirt.JPG')
# Item.create(name:"Yellow Skirt", price:"$37.99", sizes:"S,M,L", subcategory_id:5, retailer_id:3, image:'.../assets/test_data_images/Yellow_Skirt.JPG')
...
# Location.create(retailer_store_number: 304, region: "Northeast", location_type: "Urban", address: "20 W 34th St, New York, NY 10001", phone_number: "212-323-4345", retailer_id:3, latitude:40.7484, longitude:-73.9857)
# Location.create(retailer_store_number: 402, region: "Northeast", location_type: "Urban", address: "89 E 42nd St, New York, NY 10017", phone_number: "212-454-5465", retailer_id:2, latitude:40.7527, longitude:-73.9772)
# Location.create(retailer_store_number: 605, region: "Northeast", location_type: "Urban", address: "4 Pennsylvania Plaza, New York, NY 10001", phone_number: "212-543-3456", retailer_id:1, latitude:40.7505, longitude:-73.9934)
